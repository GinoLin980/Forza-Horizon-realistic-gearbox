...
class Pages(PageChange):
    ...
    def HomePage(self, started):
        ...
        if started:
            ...
            self.gear_label = ctk.CTkLabel(self.page, text="D1", font=ctk.CTkFont(size=20, weight='bold'))
            drive_mode_label = ctk.CTkLabel(self.page, text=f"Change the driving mode by clicking\n{point}7: Comfort\n{point}8: Sports\n{point}9: Eco\n{point}0: Manual", justify='left', font=ctk.CTkFont(size=20, weight='bold'))
    ...
    def __init__(
        ...
        **kwargs,
        ...
        quit_button = ctk.CTkButton(
            ...
            text="Quit",
            hover_color="red",
            command=lambda: (stopWhile(), sys.exit()),
        )
        ...
        try:
            ...
            if need_updated:
                ...
                yes_button = ctk.CTkButton(
                    update_window,
                    text="Yes",
                    command=lambda: (webbrowser.open_new_tab(REPO_URL), update_window.quit(), update_window.destroy()))
                no_button = ctk.CTkButton(update_window, text="No", command=lambda: (update_window.quit(), update_window.destroy()))
